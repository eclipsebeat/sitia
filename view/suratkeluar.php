...
<html>
 <head>
  <title>RUH Arsip Surat Keluar</title>
   <!-- Bootstrap -->
	...
	<div class="container">
		...
		<div class="masthead-pad">
			...
			<div class="masthead-text">
				<h2>RUH Arsip Surat Keluar</h2>
				<p>Pada menu ini User dapat melihat, merekam, merubah dan menghapus Arsip Surat Keluar.</p>
			</div> <!-- /.masthead-text -->
...
<?php
	...
	foreach($all as $display){
			...
			echo "<td>
					<a href=\"suratkeluar.php?modul=ubah&id=".$display['arsip_id']."\">
						<i class=\"icon-edit\"></i>
						<span>Ubah</span>       					
					</a>
				  </td>";
			echo "<td>
					<a href=\"suratkeluar.php?delete=".$display['arsip_id']."\" data-confirm='Anda Yakin Akan menghapus Arsip : ".$display['nama_arsip']." ?'>					
...
<div id="content">
	...
	?>
			<table class="table table-bordered">
				...
				<tr>
					<td>Kepada</td>
					<td colspan="2"><?php echo $display['kepada'];?></td>
				</tr>
				<tr>
					<td>Penerbit</td>
					<td colspan="2"><?php echo $display['nmseksi'];?></td>
				</tr>				
				<tr>
					<td>Uraian</td>
