...
<html>
 <head>
  <title>RUH Arsip Laporan Pertanggungjawaban Penerimaan dan Pengeluaran Negara</title>
   <!-- Bootstrap -->
	...
	<div class="container">
		...
		<div class="masthead-pad">
			...
			<div class="masthead-text">
				<h2>RUH Arsip Laporan Pertanggungjawaban Penerimaan dan Pengeluaran Negara</h2>
				<p>Pada menu ini User dapat melihat, merekam, merubah dan menghapus Arsip Laporan Pertanggungjawaban Penerimaan dan Pengeluaran Negara.</p>
			</div> <!-- /.masthead-text -->
...
<div id="content">
	...
	<div class="container">
	<div id="legend">
	  <legend class=""><a href="spj_bendum.php">Daftar Arsip</a> | <a href="spj_bendum.php?modul=tambah">Rekam Arsip</a></legend>
	</div>
...
<?php
	foreach($all as $display){
			...
			echo "<td>
					<a href=\"spj_bendum.php?modul=ubah&id=".$display['arsip_id']."\">
						<i class=\"icon-edit\"></i>
						<span>Ubah</span>       					
					</a>
				  </td>";
			echo "<td>
					<a href=\"spj_bendum.php?delete=".$display['arsip_id']."\" data-confirm='Anda Yakin Akan menghapus Arsip : ".$display['nama_arsip']." ?'>					
